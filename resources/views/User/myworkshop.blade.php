...
<script>
            ...
            .then(data => {
                ...
                let footerContent = `
                    <div class="space-y-3">
                        ...
                        <a href="/pengguna/workshop/${data.workshop_id}/forum" 
                           onclick="closeWorkshopModal()"
                           class="block w-full px-6 py-3 bg-white border-2 border-[#057A55] text-[#057A55] hover:bg-[#057A55] hover:text-white rounded-lg font-medium transition-all flex items-center justify-center shadow-md hover:shadow-lg">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    function closeWorkshopModal(event) {
        // Jika dipanggil dengan event, cek apakah klik di backdrop
