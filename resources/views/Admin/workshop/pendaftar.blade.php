        ...
        <div class="mb-8">
            ...
            <nav class="mb-4" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-sm text-gray-600">
                    ...
                    <li><a href="{{ route('admin.workshop.show', $workshop->workshop_id) }}" class="hover:text-gray-900">{{ $workshop->judul }}</a></li>
                    <li>
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                        </svg>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-2">
                        <div class="w-3 h-3 bg-[#068B4B] rounded-full"></div>
                        <h1 class="text-2xl font-bold text-[#068B4B]">
                            {{ $workshop->judul }}
                        </h1>
                    </div>
                    <div class="flex items-center space-x-2 text-[#068B4B]">
