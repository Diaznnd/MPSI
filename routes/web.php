...
// Public helper route: redirect user (or guest) to the appropriate workshop page based on role
Route::get('/workshop/redirect/{workshop}', [LandingPageController::class, 'redirectToRoleWorkshop'])->name('workshop.redirect');
